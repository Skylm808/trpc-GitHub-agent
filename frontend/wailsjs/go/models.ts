...
export namespace domain {
	...
	export class RepositoryQuestionTurn {
	    question: string;
	    answer: string;

	    static createFrom(source: any = {}) {
	        return new RepositoryQuestionTurn(source);
	    }
	...
	export class RepositoryQuestionRequest {
	    full_name: string;
	    question: string;
	    history: RepositoryQuestionTurn[];
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.full_name = source["full_name"];
	        this.question = source["question"];
	        this.history = this.convertValues(source["history"], RepositoryQuestionTurn);
	    }
